...
$excelku->getActiveSheet()->setCellValue('A2', "DINAS KEPENDUDUKAN DAN PENCATATAN SIPIL");
$excelku->getActiveSheet()->mergeCells('A3:H3');
$excelku->getActiveSheet()->setCellValue('A3', "KABUPATEN BADUNG");
$excelku->getActiveSheet()->mergeCells('A4:H4');
$excelku->getActiveSheet()->setCellValue('A4', "BIDANG PIAK DAN PEMANFAATAN DATA");
$excelku->getActiveSheet()->mergeCells('A5:H5');
$excelku->getActiveSheet()->setCellValue('A5', " Jl. Raya Sempidi Mangupura, Sempidi, Kec. Mengwi, Kabupaten Badung, Bali 80351");
