        ...
        <nav class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">ARSIP SURAT <span class="logo-dec">DisdukCapil</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <div class="logo">
		            <img src="img/logobadung (3).png" alt="" />
	            </div>
              <h3 class="bnr-sub-title">SISTEM INFORMASI PENGARSIPAN SURAT</h3>
                <h3 class="bnr-sub-title"><span class="logo-dec">Disdukcapil Badung</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p class="sub-title pad-bt15">Website ini berguna untuk pengarsipan Surat Masuk dan Surat Keluar di DisdukCapil</p><p>Surat diarsipkan dalam format PDF lalu disesuaikan nomor urutnya.</p>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row text-center">
          <p>&copy; TEKNIK INFORMATIKA. All Rights Reserved.</p>
          <div class="credits">
            <!-- 
